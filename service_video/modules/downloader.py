...
class Video:
    ...
    @staticmethod
    def uploadInFileStorage(AWS_ACCESS_KEY, AWS_SECRET_KEY, user_email, file_path):
        transport = WassabiStorageTransport(AWS_ACCESS_KEY, AWS_SECRET_KEY, user_email=user_email,
...
class Downloader:
    ...
    def __init__(self, url=None, dir=None, resolution=None, best_resolution=None):
        self.url = url
        self.dir = dir
        self.video = None
    ...
    def uploadInFileStorage(self, AWS_ACCESS_KEY, AWS_SECRET_KEY, user_email, file_path):
        try: return self.video.uploadInFileStorage(AWS_ACCESS_KEY, AWS_SECRET_KEY, user_email, file_path)
        except: raise
